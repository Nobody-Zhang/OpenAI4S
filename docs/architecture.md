...
| Notebook export | Deterministic Python and R `.ipynb` generation, a stable ZIP bundle, and `GET /frames/{id}/notebook/export`. | The current UI has no dedicated `.ipynb` download control; Markdown and Artifact ZIP exports remain separate. |
