...
| Python/R `.ipynb` export | Deterministic language export/ZIP route is implemented. The static UI does not yet expose a dedicated `.ipynb` button; Markdown and Artifact ZIP downloads remain visible. |
